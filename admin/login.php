                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Đăng nhập vào trang Admin!</h1>
                                    </div>
                                    <form action="" class="user" method="post">
                                        <div class="form-group">
                                            <input type="text" name="username" id="username" class="form-control form-control-user" required placeholder="Email hoặc username" value="<?= $username ?>">
                                        </div>
                                        <div class="form-group">
